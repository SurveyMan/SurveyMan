...
public class SurveyPoster {
    ...
    private RequesterService service = new RequesterService(new PropertiesClientConfig(config));
    public Map<String, String> parameters = scalautils.ParamParse.getMap();
